      ...
      <template #footer>
        <div class="card flex items-center w-full p-4">
          <div
            v-for="card in cards"
            :key="card"
            class="mx-3 w-12 h-20 bg-blue-500 text-white font-bold flex items-center justify-center border-2 border-gray-200 shadow-md rounded-md cursor-pointer transition duration-300 transform hover:-translate-y-3 p-1"
            @click="vote(card)"
            v-html="card"
          />
        </div>
